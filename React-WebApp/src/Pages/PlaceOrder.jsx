...
const PlaceOrder = () => {
  ...
  const Array = ['DELIVERY','INFORMATION'];
  const Array2 = ['PAYMENT','METHOD'];
    ...
    {/*------------------------Payment Method Section---------------------- */} 
        <div className='flex flex-col gap-3 lg:flex-row'>
         ...
         <div className='w-full text-end mt-8'>
           <button onClick={() => navigate('/orders')} className='bg-blue-500 text-white py-2 px-4 rounded'>Place Order</button>
         </div>
       </div>
      </div>
    </div>
